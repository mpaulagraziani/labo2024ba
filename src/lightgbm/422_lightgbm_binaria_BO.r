...
hs <- makeParamSet(
  ...
  makeIntegerParam("max_depth", lower = -1L, upper = 20L),  # Profundidad máxima del árbol
  ...
  makeNumericParam("bagging_fraction", lower = 0.5, upper = 1.0),  # Fracción de bagging
  makeIntegerParam("bagging_freq", lower = 0L, upper = 10L)  # Frecuencia de bagging
)
