...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912)


  # Meses que se utilizarán para entrenamiento 
  training_months_total <- c(202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910)
  
  # Lista de combinaciones de validation y testing para iterar
  valid_test_pairs <- list(
    c(202101, 202102),
    c(202102, 202103),
    c(202103, 202104),
    c(202104, 202105)
  ...
  # Para cada iteración, modificar los meses de training, validation y testing
  for (pair in valid_test_pairs) {
    validation_month <- pair[1]
    testing_month <- pair[2]
    
    # Filtrar los meses de training que son anteriores al mes de validación
    training_months <- training_months_total[training_months_total < validation_month]
    
    # Tomar solo los últimos 15 meses
    training_months <- tail(training_months, 15)
    
    # Asignar los meses de training, validation y testing
    param_local$train$training <- training_months
    param_local$train$validation <- validation_month
    param_local$train$testing <- testing_month
    
    # Entrenar el modelo usando param_local con los meses configurados
    print(paste("Training:", paste(param_local$train$training, collapse = ",")))
    print(paste("Validation:", validation_month))
    print(paste("Testing:", testing_month))
  }
