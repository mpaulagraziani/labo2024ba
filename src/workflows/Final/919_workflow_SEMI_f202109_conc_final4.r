...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202105, 202104, 202103, 202102, 202101, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905)
  
  
  # Meses que se utilizarán para entrenamiento 
  training_months_total <- c(202105, 202104, 202103, 202102, 202101, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903)
