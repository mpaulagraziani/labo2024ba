...
data_v1 <- read.table("/home/consultorio_grazianimp/buckets/b1/flow/wf_julio-001/011-EV_evaluate_conclase_gan/ganancias_01_020_v1.txt", header = TRUE, sep = "\t")
data_v2 <- read.table("/home/consultorio_grazianimp/buckets/b1/flow/wf_julio-002/011-EV_evaluate_conclase_gan/ganancias_01_069_v2.txt", header = TRUE, sep = "\t")
...
write.csv(final_data, "/home/consultorio_grazianimp/buckets/b1/comparaciones/resultado_comparacion_v1_vs_v2.csv", row.names = FALSE)
