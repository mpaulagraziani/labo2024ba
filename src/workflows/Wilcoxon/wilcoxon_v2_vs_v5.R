...
data_v2 <- read.table("/home/consultorio_grazianimp/buckets/b1/flow/wf_julio-006/011-EV_evaluate_conclase_gan/ganancias_01_054_v5.txt", header = TRUE, sep = "\t")
...
write.csv(final_data, "/home/consultorio_grazianimp/buckets/b1/comparaciones/resultado_comparacion_v2_vs_v5.csv", row.names = FALSE)
