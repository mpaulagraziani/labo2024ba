...
data_v2 <- read.table("/home/consultorio_grazianimp/buckets/b1/flow/wf_julio-009/011-EV_evaluate_conclase_gan/ganancias_01_041_v8.txt", header = TRUE, sep = "\t")
...
colnames(final_data)[3] <- "ganancia_promedio_exp8"

# Mostrar los resultados
print(final_data)

# Exportar el resultado a un archivo CSV
write.csv(final_data, "/home/consultorio_grazianimp/buckets/b1/comparaciones/resultado_comparacion_v2_vs_v8.csv", row.names = FALSE)
